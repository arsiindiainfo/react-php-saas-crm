  ...
  return (
    <footer className="border-t border-gray-200 bg-gradient-to-br from-white via-blue-50/40 to-white">
          ...
          {CONTACT_CHIPS.map((chip) => (
            ...
            >
              ...
              <span className="min-w-0">
                <span className="block text-xs font-semibold text-gray-900">{chip.label}</span>
                <span className="block truncate text-[11px] text-gray-500">{chip.value}</span>
              </span>
            </a>
          ))}
        </div>
      ...
      <div className="bg-gray-900 px-6 py-3">
        <div className="mx-auto flex max-w-[1600px] flex-col items-center justify-between gap-2 text-[11px] text-gray-400 sm:flex-row">
          <span>&copy; 2026 Arsi India Info. All rights reserved.</span>
